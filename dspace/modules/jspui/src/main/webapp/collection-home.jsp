...
%>
      ...
      <a class="statisticsLink btn btn-warning" href="<%= request.getContextPath() %>/handle/<%= collection.getHandle() %>/statistics"><fmt:message key="jsp.collection-home.display-statistics"/></a>
      </h2></div>
<%  if (logo != null) { %>
        <div class="col-md-4">
...
<% 	} %>
  ...
  <div class="panel panel-primary">
  	<div class="panel-heading">
        <fmt:message key="jsp.general.browse"/> <fmt:message key="jsp.general.browse-en"/> <%= name %>
	</div>
