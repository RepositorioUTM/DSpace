 ...
 * @version $Revision$
 */
public class VideoListServlet extends DSpaceServlet
{
    /** log4j category */
    private static final Logger log = Logger.getLogger(VideoListServlet.class);
            ...
            SQLException, AuthorizeException
    {
        ...
        JSPManager.showJSP(request, response, "/video-list.jsp");
    }
    /*
